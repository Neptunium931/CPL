...
\subsection{Test 5 : L'attaquant place son CPL derrière les éléments de sécurité élétricque}
\paragraph{Sans ARP Spoofing :}
Dans ce scénario, l'attaquant place son CPL derrière les éléments de sécurité du réseau élétricque. Cela signifie que le CPL est isolé des autres CLP par un disjoncteur et un différentiel.
